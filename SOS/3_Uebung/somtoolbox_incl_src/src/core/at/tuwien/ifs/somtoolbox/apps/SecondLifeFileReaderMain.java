 ...
 * 
 * @author neumayer
 * @version $Id: SecondLifeFileReaderMain.java 2874 2009-12-11 16:03:27Z frank $
 */
public class SecondLifeFileReaderMain {
    ...
    public static void plot(double[][][] positions, double[][][] centroids, double[][][] snappedCentroids, double xSize, double ySize, double zSize) {
        // FIXME
    ...
    public static Point3d[][] aggregateLines(double[][][] centroids, int aggregationTargetNumberOfComponents,
        ...
        WardClustering<ComponentLine3D> wardClustering = new WardClustering<ComponentLine3D>(dist, aggregationTargetNumberOfComponents);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Fetched coordinates for " + positions.length + " avatars for region " + slifr.getRegions()[0]);
        int k = 12;
        ...
        double[][][] snappedCentroids = SecondLifeFileReaderMain.getSnappedCentroids(centroids, xSize, ySize, zSize, lineDistanceFunction);
        ...
        double[][][] aggregatedCentroids = SecondLifeInputFileReader.point2DoubleArray(SecondLifeFileReaderMain.aggregateLines(centroids, 12,
        ...
        double[][][] aggregatedSnappedCentroids = SecondLifeFileReaderMain.getSnappedCentroids(aggregatedCentroids, xSize, ySize, zSize,
                lineDistanceFunction);
