 ...
 * 
 * @author Philip Langer <p[dot]langer[at]gmail[dot]com>
 */
public class GHSOMNavigationPanel extends AbstractSelectionPanel implements ActionListener {
    ...
    private void addLayerFrame(GrowingLayer layer) {
        ...
        if (layer.getSuperUnit() != null) {
            newSomFrame.setTitle("SubLayer of Unit " + layer.getSuperUnit().getXPos() + "/" + layer.getSuperUnit().getYPos());
        } else {
    ...
    private void drillDown(Unit unit) {
        ...
        addLayerFrame((GrowingLayer) unit.getMappedSOM().getLayer());
        // TODO doesn't work
                ...
                public void actionPerformed(ActionEvent event) {
                    ...
                    if (!button.getName().equals("" + currentLevel)) {
                        ...
                        if (currentLevel == 0) {
                            ...
                            System.out.println("armed / pressed / selected " + armed + " / " + pressed + " / " + selected);
    ...
    /**
     * Returns <code>true</code> if the specified <code>unit</code> has an underlying map and is therefore drill-down-able.
     * 
     ...
     * 
     * @param growingLayer
     * @return <code>true</code> if roll up is possible, <code>false</code> otherwhise.
     */
