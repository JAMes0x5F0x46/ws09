 ...
 * @author Rudolf Mayer
 * @version $Id: InputDatum.java 2874 2009-12-11 16:03:27Z frank $
 */
public class InputDatum {
    ...
    /**
     * Adds an arbitrary key/value property to the InputDatum. Useful for GUIs that need to attach various information to a datum. If value is
    ...
    public boolean equals(Object obj) {
        return obj instanceof InputDatum && ((InputDatum) obj).getLabel().equals(getLabel()) && ((InputDatum) obj).getVector().equals(getVector());
    }
