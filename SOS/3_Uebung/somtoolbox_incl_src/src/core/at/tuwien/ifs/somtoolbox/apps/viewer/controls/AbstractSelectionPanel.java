...
/**
 * @author Rudolf Mayer
 * @version $Id: AbstractSelectionPanel.java 2874 2009-12-11 16:03:27Z frank $
 */
public abstract class AbstractSelectionPanel extends AbstractViewerControl implements UnitSelectionListener, ListSelectionListener {
    ...
    public void unitSelectionChanged(Object[] selection, boolean newSelection) {
        ...
        for (int u = 0; u < selection.length; u++) {
            ...
            // TODO: for some reason the ordering of the units gets mixed up. in PlaySOMPlayer it works with this approach...
            ...
            for (String element : names) {
                ...
                try {
                    ...
                    // }
                    absPathVectors[currentSelectionArea].add(CommonSOMViewerStateData.fileNamePrefix + URLDecoder.decode(element, "UTF-8")
                            + CommonSOMViewerStateData.fileNameSuffix);
                } catch (UnsupportedEncodingException e) {
                    Logger.getLogger("at.tuwien.ifs.somtoolbox").warning("Failed to decode string ... adding encoded one");
