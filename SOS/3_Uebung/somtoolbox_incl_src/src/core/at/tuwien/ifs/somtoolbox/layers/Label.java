...
/**
 * A simple class representing a unit label. This class holds the name, the value and the quantization error of a label. It also provides static
 * methods for sorting an array of labels according to on of the three properties mentioned before.
 * 
 * @author Michael Dittenbach
 * @version $Id: Label.java 2874 2009-12-11 16:03:27Z frank $
 */
public class Label implements Serializable {
    ...
    /**
     * Convenience method for sorting an array of labels by their values and quantization errors (in case of equal value). The sorting order is
     * specified separately for both criteria by arguments <code>order1</code> and <code>order2</code>.
     * 
     * @param labels an array of labels to be sorted.
     * @param order1 the sorting order for the primary criterion, either ascending ({@link #SORT_ASC}) or descending ({@link #SORT_DESC}).
     * @param order2 the sorting order for the secondary criterion, either ascending ({@link #SORT_ASC}) or descending ({@link #SORT_DESC}).
     */
    ...
    /**
     * Convenience method for sorting an array of labels by their quantization errors and values (in case of equal quantization errors). The sorting
     * order is determined separately for both criteria by arguments <code>order1</code> and <code>order2</code>.
     * 
     * @param labels an array of labels to be sorted.
     * @param order1 the sorting order for the primary criterion, either ascending ({@link #SORT_ASC}) or descending ({@link #SORT_DESC}).
     * @param order2 the sorting order for the secondary criterion, either ascending ({@link #SORT_ASC}) or descending ({@link #SORT_DESC}).
