    ...
    public Point2D[] snap(Point2D[] line) {
        ...
        for (int i = 0; i < line.length; i++) {
            ...
            for (int j = 0; j < neighbouringPoints.length; j++) {
                ...
                Point2D[] lineSegmentForward = snapPoint(neighbouringPoints[j], line, i + 1, +1);
                Point2D[] lineSegmentBackward = snapPoint(neighbouringPoints[j], line, i - 1, -1);
        ...
        for (int i = 0; i < allSnappedLines.size(); i++) {
            Point2D[] currentLine = (Point2D[]) allSnappedLines.get(i);
