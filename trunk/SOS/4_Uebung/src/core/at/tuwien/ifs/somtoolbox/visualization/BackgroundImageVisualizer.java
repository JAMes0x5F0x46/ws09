...
/**
 * Interface defining a visualisation of a SOM. If you want to provide new visualisers, you have to implement this interface and register your
 * visualisation in {@link Visualizations#getAvailableVisualizations()}. If your visualisation requires user input to e.g. control parameters, extend
 ...
 * @author Rudolf Mayer
 * @version $Id: BackgroundImageVisualizer.java 2874 2009-12-11 16:03:27Z frank $
 */
public interface BackgroundImageVisualizer extends Comparable<BackgroundImageVisualizer> {
     ...
     */
    public BufferedImage getVisualization(int variantIndex, GrowingSOM gsom, int width, int height) throws SOMToolboxException;
    ...
    /**
     * Returns HTML control elements (inputs) to be used by the webserver version of the SOM. Only the inputs are required, the surrounding form will
     * be provided.
     * 
    ...
    /**
     * Returns all visualisation flavours of the given variant, e.g. applying possible parameters to the visualisation, etc.<br/>
     * The keys in the map shall be specific suffixes that describe how the flavours were constructed, e.g. they might contain parameter names and
     * values.
     */
    ...
    /**
     * Returns all visualisation flavours of the given variant just as {@link #getVisualizationFlavours(int, GrowingSOM, int, int)}, but limiting the
     * number of flavours to the given maximum number.
     */
    ...
    /**
     * Returns all visualisation flavours of the given variant just as {@link #getVisualizationFlavours(int, GrowingSOM, int, int)}, but limiting the
     * number of flavours by the given parameters.
     */
