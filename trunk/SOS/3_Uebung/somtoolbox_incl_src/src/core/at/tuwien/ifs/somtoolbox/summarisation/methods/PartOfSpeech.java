 ...
 * @version $Id: PartOfSpeech.java 2937 2009-12-15 01:03:56Z mayer $
 */
public class PartOfSpeech {
    ...
    /**
     * returns type of tokens in a sentence, whether nouns, verbs...
     * 
     * @param line
     * @param type
     * @return
    ...
    public ArrayList<String> getTokens(String line, String type) {
        ...
        try {
            ...
            for (int i = 0; i < tokens.length; ++i) {
                ...
                // # of verbs
                if (type == VERB) {
                    if (tags[i].equals("VVB") || tags[i].equals("VVD") || tags[i].equals("VVG") || tags[i].equals("VVI")
                            || tags[i].equals("VVN") || tags[i].equals("VVNJ") || tags[i].equals("VVGJ") || tags[i].equals("VVGN")
                            || tags[i].equals("VVZ")) {
                        resultarray.add(tokens[i]);
                    }
                }
                ...
                // # of articles
                if (tokens[i].equals("the") || tokens[i].equals("The") || tokens[i].equals("THE") || tokens[i].equals("a") || tokens[i].equals("A")
                        || tokens[i].equals("an") || tokens[i].equals("An") || tokens[i].equals("AN")) {
                    // do nothing
                }
                ...
                if (tags[i].equals("VM") || tags[i].equals("VBB") || tags[i].equals("VBD") || tags[i].equals("VBG")
                        || tags[i].equals("VBI") || tags[i].equals("VBN") || tags[i].equals("VBZ") || tags[i].equals("VDB")
                        || tags[i].equals("VDD") || tags[i].equals("VDG") || tags[i].equals("VDI") || tags[i].equals("VDN")
                        || tags[i].equals("VDZ") || tags[i].equals("VHB") || tags[i].equals("VHD") || tags[i].equals("VHG")
