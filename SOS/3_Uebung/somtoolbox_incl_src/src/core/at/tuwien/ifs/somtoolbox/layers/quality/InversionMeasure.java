 ...
 * @version $Id: InversionMeasure.java 2874 2009-12-11 16:03:27Z frank $
 * 
 */
public class InversionMeasure extends AbstractQualityMeasure {
    ...
    public InversionMeasure(Layer layer, InputData data) {
                    ...
                    for (int n3 = 0; n3 < neurons.size(); n3++) {
                        ...
                        if (n3 != n1 && n3 != n2) {
                            ...
                            try { // Formula by Zrehen and Blayo
                                t1 = metric.distance(neuro3.getWeightVector(), multScalVec(0.5, (addVec(neuro1.getWeightVector(),
                                        neuro2.getWeightVector()))));
        ...
        // number of pairs
        inversion = 1.0 / ((double) Ck * ((double) N - 2.0)) * (double) sum;
    }
