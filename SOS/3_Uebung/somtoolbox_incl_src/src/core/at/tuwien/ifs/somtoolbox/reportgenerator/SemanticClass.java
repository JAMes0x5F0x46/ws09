 ...
 * @version $Id: SemanticClass.java 2874 2009-12-11 16:03:27Z frank $
 */
public class SemanticClass {
    ...
    /**
     * Lists all different partitions of the class (a Partition is consicered a connected Area of units with no more than 1 as distance between
     * ewachunit)
     * 
     * @param members
     * @return
    ...
    public void calculateClassPartitions() {
        ...
        for (int i = 0; i < UnitswithClassList.size(); i++) {
            ArrayList<Integer> trail = getTrail(i, new ArrayList()); // Gets the trail, since there are manyequal trails, only keep unique trails
    ...
    /**
     * calculates the point with the most disnace to the classcenter
     * 
     * @return
     */
     ...
     * 
     * @param setQMIntersectionClassArrayList
     * @return
     */
