 ...
 * @author Michael Groh
 * @version $Id: ClusterConnectionsVisualizer.java 2874 2009-12-11 16:03:27Z frank $
 */
public class ClusterConnectionsVisualizer extends AbstractBackgroundImageVisualizer implements BackgroundImageVisualizer {
     ...
     * FIXME: this should be in {@link GrowingLayer}, similar to the method in {@link UMatrix#calculateDissimilarityMatrix}
     * 
     * @param som for vis
