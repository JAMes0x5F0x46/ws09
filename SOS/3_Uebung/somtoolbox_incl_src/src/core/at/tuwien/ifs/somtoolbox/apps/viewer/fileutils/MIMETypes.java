...
public class MIMETypes {
    ...
    private String PLAYLIST_TMP_FILENAME = System.getProperty("java.io.tmpdir") + System.getProperty("file.separator") + "tmp.m3u";
    ...
    public boolean hasSingleFileType(Object[] playList) {
        ...
        String type = (String) getFileType((String) playList[0]);

        for (int i = 0; i < playList.length; i++) {
            if (!type.equals(getFileType((String) playList[i])))
                return false;
        }
        return true;
    }
    ...
    public void doSysCalls(Object[] playList) {
        ...
        for (int i = 0; i < playList.length; i++) {
            ...
            call("firefox", URLEncoder.encode((String) playList[i]));
        }
    ...
    public void call(String app, String params) {
        try {
            ...
            Logger.getLogger("at.tuwien.ifs.somtoolbox").warning("Error executing external application: " + app + " " + params);
        }
    }
