 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: LabelDescription.java 2874 2009-12-11 16:03:27Z frank $
 */
public class LabelDescription {
    ...
    /** The font to draw the label with. This will be initially a copy of {@link #DEFAULT_FONT}, with only the size modified to {@link #fontSize} */
    private Font font;
    ...
    /**
     * Compares two {@link LabelDescription} with each other. They are considered identical if the values of {@link #getText()}, {@link #getX()},
     * {@link #getY()}, {@link #getFontSize()}, {@link #getColor()} and {@link #getRotation()} are equal.
     */
    public boolean equals(Object obj) {
        ...
        if (getText().equals(other.getText()) && getX() == other.getX() && getY() == other.getY() && getFontSize() == other.getFontSize()
                && getColor() == other.getColor() && getRotation() == other.getRotation()) {
            return true;
        } else {
            return false;
        }
