 ...
 * @version $Id: TopographicError.java 2874 2009-12-11 16:03:27Z frank $
 */
public class TopographicError extends AbstractQualityMeasure {
    ...
    public TopographicError(Layer layer, InputData data) {
        ...
        ProgressListener progress = ProgressListenerFactory.getInstance().createProgressListener(numVectors, "Processing vector ", 10);
