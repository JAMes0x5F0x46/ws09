 ...
 * @version $Id: ColorGradientFactory.java 2874 2009-12-11 16:03:27Z frank $
 */
public class ColorGradientFactory {
    ...
    public static ColorGradient galaxyGradientYellow() {
        ...
        Color[] gradColors = { new Color(0, 0, 0), new Color(32, 32, 32), new Color(96, 96, 96), new Color(153, 153, 153), new Color(204, 204, 204),
                new Color(255, 244, 164), new Color(255, 255, 209) };
    ...
    public static ColorGradient galaxyGradientGrey() {
        ...
        Color[] gradColors = new Color[] { new Color(0, 0, 0), new Color(66, 66, 66), new Color(96, 96, 96), new Color(100, 100, 100),
                new Color(110, 110, 110), new Color(120, 120, 120), new Color(130, 130, 130) };
        ColorGradient gradient = null;
        try {
            gradient = new ColorGradient(gradPoints, gradColors);
        } catch (SOMToolboxException e) {
    ...
    public static ColorGradient CartographyColorGradient() {
        ...
        Color[] gradColors = { new Color(0, 0, 128), new Color(0, 0, 255), new Color(0, 128, 255), new Color(240, 240, 64), new Color(32, 160, 0),
                new Color(224, 224, 0), new Color(128, 128, 128), new Color(255, 255, 255) };
    ...
    public static ColorGradient CartographyMountain1aGradient() {
        ...
        Color[] gradColors = { new Color(0, 100, 0), new Color(200, 200, 100), new Color(150, 0, 0), new Color(150, 150, 150),
    ...
    public static ColorGradient CartographyMountain1bGradient() {
        ...
        Color[] gradColors = { new Color(0, 100, 70), new Color(25, 128, 50), new Color(224, 210, 122), new Color(162, 71, 3), new Color(160, 0, 0),
                new Color(120, 120, 120), new Color(255, 255, 255) };
        ColorGradient cartographyGradient = null;
        try {
            cartographyGradient = new ColorGradient(gradPoints, gradColors);
        } catch (SOMToolboxException e) {
    ...
    public static ColorGradient CartographyMountain2aGradient() {
        ...
        Color[] gradColors = { new Color(220, 250, 178), new Color(82, 184, 59), new Color(101, 148, 52), new Color(240, 157, 1),
                new Color(139, 11, 0), new Color(104, 40, 15), new Color(139, 95, 70), new Color(189, 189, 189), new Color(254, 252, 255) };
        ColorGradient cartographyGradient = null;
        try {
            cartographyGradient = new ColorGradient(gradPoints, gradColors);
        } catch (SOMToolboxException e) {
    ...
    public static ColorGradient CartographyMountain2bGradient() {
        double[] gradPoints = { 0.0, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0 };
        Color[] gradColors = { new Color(175, 240, 232), new Color(220, 250, 178), new Color(82, 184, 59), new Color(101, 148, 52),
                new Color(240, 157, 1), new Color(139, 11, 0), new Color(104, 40, 15), new Color(139, 95, 70), new Color(189, 189, 189) };
        ColorGradient cartographyGradient = null;
        try {
            cartographyGradient = new ColorGradient(gradPoints, gradColors);
        } catch (SOMToolboxException e) {
    ...
    public static ColorGradient CartographyMountain2cGradient() {
        ...
        Color[] gradColors = { new Color(175, 240, 232), new Color(220, 250, 178), new Color(82, 184, 59), new Color(101, 148, 52),
                new Color(240, 157, 1), new Color(139, 11, 0), new Color(104, 40, 15), new Color(139, 95, 70), new Color(200, 200, 205) };
        ColorGradient cartographyGradient = null;
        try {
            cartographyGradient = new ColorGradient(gradPoints, gradColors);
        } catch (SOMToolboxException e) {
    ...
    public static ColorGradient RGBGradient() {
        ...
        Color[] gradColors = { new Color(255, 0, 0), new Color(255, 255, 0), new Color(0, 255, 0), new Color(0, 255, 255), new Color(0, 0, 255) };
        ColorGradient cartographyGradient = null;
        try {
            cartographyGradient = new ColorGradient(gradPoints, gradColors);
        } catch (SOMToolboxException e) {
    ...
    public static ColorGradient RGBGradientLight() {
        double[] gradPoints = { 0.0, 0.25, 0.5, 0.75, 1.0 };
        Color[] gradColors = { new Color(255, 90, 90), new Color(255, 255, 90), new Color(90, 255, 90), new Color(90, 255, 255),
                new Color(90, 90, 255) };
