 ...
 * @version $Id: SilhouetteValue.java 2874 2009-12-11 16:03:27Z frank $
 */
public class SilhouetteValue extends AbstractQualityMeasure {
    ...
    public SilhouetteValue(Layer layer, InputData data) {
        ...
        StdErrProgressWriter progressWriter = new StdErrProgressWriter(layer.getXSize() * layer.getYSize(), "Calculating SilhouetteValue for unit ",
                50);
