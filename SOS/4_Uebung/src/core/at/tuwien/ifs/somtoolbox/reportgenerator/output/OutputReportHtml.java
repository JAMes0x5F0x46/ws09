 ...
 * @author Rudolf Mayer
 * @version $Id: OutputReportHtml.java 2977 2009-12-16 18:07:27Z mayer $
 */
public class OutputReportHtml implements OutputReport {
    ...
    /**
     * prints the start of the report. includes the page start, title, and references to JS and CSS files. The contents are read from
     * rsc/reportGenerator/pageStart.html
     */
    ...
    private String getHeadContent() {
        try {
            return "<style>\n" + FileUtils.readFileContents("./src/core/rsc/reportGenerator/somReporter.css") + "\n</style>\n";
        } catch (IOException e) {
            e.printStackTrace();
        }
        return "";
