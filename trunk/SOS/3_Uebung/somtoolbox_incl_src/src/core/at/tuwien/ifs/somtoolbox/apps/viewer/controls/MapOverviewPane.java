...
/**
 * Implements an overview of the {@link MapPNode}, indicating the currently displayed area of the map. Allows also to move the currently displayed
 * area.
 * 
 * @author Michaedl Dittenbach
 * @version $Id: MapOverviewPane.java 2874 2009-12-11 16:03:27Z frank $
 */
public class MapOverviewPane extends AbstractViewerControl {
    private static final long serialVersionUID = 1L;

    private MapOverviewCanvas moc;
    ...
    public Dimension getPreferredSize() {
        return new Dimension(state.controlElementsWidth, 150);
    }
