 ...
 * @version $Id: Commons.java 2874 2009-12-11 16:03:27Z frank $
 */
public class Commons {
    ...
    public static final DataLine.Info datalineformat_info = new DataLine.Info(SourceDataLine.class, Commons.datalineformat);
    ...
    public static final String[] A_FINDME_FILES = { "00.wav", "01.wav", "02.wav", "03.wav", "04.wav", "05.wav", "06.wav", "07.wav", "08.wav",
            "09.wav", "10.wav" };
    ...
    public static void playSound(String[][] aFiles, int iLine) {
        try {
            SourceDataLine sdl = (SourceDataLine) LineListModel.getOurMixerAt(iLine).getLine(Commons.datalineformat_info);
     ...
     * JDialog</code>, but <code>java.awt.Component</code> is superclass of both.
     */
     ...
     */
    public static File getChosenFile(boolean bSave, Component parent, final String suffix, JFileChooser jfc) throws Exception {
        File f;
