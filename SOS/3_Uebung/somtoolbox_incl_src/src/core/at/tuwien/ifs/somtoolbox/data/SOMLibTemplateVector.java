 ...
 * href="http://olymp.ifs.tuwien.ac.at/somtoolbox/doc/somlibFileFormat.html#template_vector">Template Vector File</a>. See also a <a
 * href="../../../../../ssd.tv">sample TemplateVector file</a>.
 * <p>
 ...
 * @author Rudolf Mayer
 * @version $Id: SOMLibTemplateVector.java 2886 2009-12-11 22:17:58Z mayer $
 */
public class SOMLibTemplateVector extends AbstractSOMLibTemplateVector {
    ...
    /**
     * Reads the {@link TemplateVector} information from the given filename. The file format has to follow the specification given in the <a
     * href="http://olymp.ifs.tuwien.ac.at/somtoolbox/doc/somlibFileFormat.html#template_vector">SOMLib Data Files specification</a>. See also a <a
     * href="../../../../../doc/examples/ssd.tv">sample TemplateVector file</a>.
     * 
    ...
    public void readTemplateVectorFile(String templateFileName) throws IOException {
        ...
        while (line != null) {
            ...
            if (lineElements.length != numInfo) {
                throw new IOException("Template vector file corrupt in element number " + index + ": expected " + numInfo + " line elements, found "
                        + lineElements.length + " " + getErrorDetails(line, lineNumber));
                ...
                try {
                    ...
                    NumberFormatException ex = new NumberFormatException("Template vector number format corrupt in vector number " + index + ": "
                            + e.getMessage());
        ...
        if (index != dim) {
            throw new IOException("Template vector file corrupt. Incorrect number of dimensions(index=" + index + ", dim=" + dim + ").");
        }
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (line.startsWith("$TYPE")) {
                ...
                if (lineElements.length > 1) {
                    ...
                    if (numInfo < 2) {
                        throw new IOException("Template vector file format corrupt. At least 2 columns (number, label) required.");
                    }
                } else {
                ...
                if (lineElements.length > 1) {
                    try {
                        ...
                        throw new IOException(getErrorMessage("$YDIM requires a valid numeric parameter.", line, lineNumber));
                    }
                } else {
