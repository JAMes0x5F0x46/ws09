 ...
 * @author Rudolf Mayer
 * @version $Id: GrowingLayer.java 2949 2009-12-15 15:21:15Z frank $
 */
//
//
...
public class GrowingLayer implements Layer {
    ...
    private final String revision = "$Revision: 2949 $";
     ...
     *            <code>Normalization.NONE</code> or <code>Normalization.UNIT_LEN</code>.
    ...
    public QualityMeasure train(InputData data, double initialLearnrate, double initialSigma, int numIterations, int startIteration, double tau,
        ...
        if ((targetQualityValue == Double.MAX_VALUE)) {// && (tau<1)) { // to save time when using large data sets
            GrowingLayer layer0 = new GrowingLayer(1, 1, 1, "at.tuwien.ifs.somtoolbox.layers.metrics.L2Metric", dim, false, trainingProps.pca(), 7,
                    data);
