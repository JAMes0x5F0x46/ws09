...
\begin{itemize}
	...
	\item Array-Grammatiken verarbeiten nicht nur Symbol- sondern auch Positionsinformationen $\Rightarrow$ Ein-Weg Automat nicht möglich
...
\begin{itemize}
	...
	\item Jede Position eines Terminalsymbol im aktuellen Array muss mit der Position des originalen Arrays übereinstimmen.
\end{itemize}
}

\frame{\frametitle{Definition}
Ein n-dimensionaler k-head finite Array-Automat vom Typ $X$ ($X \in \{n$-\#-$cf, n$-$cf, n$-$scf, n$-$cf_1, n$-$scf_1 \ | \ n \geq 1 \}$) ist folgendermaßen definiert
...
\begin{itemize}
	...
	\item für jede Array-Produktion $p \in P$, ist $p$ von der Form	
\end{itemize}
...
\begin{itemize}
	\item Regulated Array-Grammatiken mit finite Index ist geeignete Methode für syntaktisches Pattern Recognition
	\item Mögliche Erweiterung zur Erkennung von 3-dimensionalen Objekten \newline
\end{itemize}
