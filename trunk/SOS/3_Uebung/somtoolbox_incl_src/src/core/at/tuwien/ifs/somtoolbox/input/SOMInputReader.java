 ...
 * @author Rudolf Mayer
 * @version $Id: SOMInputReader.java 2874 2009-12-11 16:03:27Z frank $
 */
public interface SOMInputReader {
    ...
    /**
     * Returns an array of strings containing the names of vectors mapped onto a certain unit specified by coordinates <code>x</code> and
     * <code>y</code>. If the coordinates are invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not
     * obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return an array of strings containing the names of vectors mapped onto a certain unit specified by coordinates <code>x</code> and
     *         <code>y</code>.
     */
    ...
    /**
     * Returns an array of double values containing the distances between mapped vectors and the unit specified by coordinates <code>x</code> and
     * <code>y</code>. If the coordinates are invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not
     * obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return an array of double values containing the distances between mapped vectors and the unit specified by coordinates <code>x</code> and
     *         <code>y</code>.
     */
    ...
    /**
     * Returns the number of subordinate maps of a certain unit specified by coordinates <code>x</code> and <code>y</code>. If the coordinates are
     * invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return the number of subordinate maps of a certain unit specified by coordinates <code>x</code> and <code>y</code>.
     */
    ...
    /**
     * Returns the number of labels of a certain unit specified by coordinates <code>x</code> and <code>y</code>. If the coordinates are invalid, an
    ...
    /**
     * Returns the number of vectors mapped onto a certain unit specified by coordinates <code>x</code> and <code>y</code>. If the coordinates are
     * invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return the number of vectors mapped onto a certain unit specified by coordinates <code>x</code> and <code>y</code>.
     */
    ...
    /**
     * Returns the quantization error of a certain unit specified by coordinates <code>x</code> and <code>y</code>. If the coordinates are invalid, an
     * <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
    ...
    /**
     * Returns the mean quantization error of a certain unit specified by coordinates <code>x</code> and <code>y</code>. If the coordinates are
     * invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
    ...
    /**
     * Returns an array of strings containing the names of labels of a certain unit specified by coordinates <code>x</code> and <code>y</code>. If the
     * coordinates are invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return an array of strings containing the names of labels of a certain unit specified by coordinates <code>x</code> and <code>y</code>.
     */
    ...
    /**
     * Returns an array of double values containing the quantization error of the labels of a unit specified by coordinates <code>x</code> and
     * <code>y</code>. If the coordinates are invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not
     * obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return an array of double values containing the quantization error of the labels of a unit specified by coordinates <code>x</code> and
     *         <code>y</code>.
     */
    ...
    /**
     * Returns an array of double values containing the mean values of the labels of a unit specified by coordinates <code>x</code> and <code>y</code>
     * . If the coordinates are invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not obliged to catch
     * it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return an array of double values containing the mean values of the labels of a unit specified by coordinates <code>x</code> and <code>y</code>
     *         .
     */
    ...
    /**
     * Returns an array of strings containing the file names of subordinate maps of a certain unit specified by coordinates <code>x</code> and
     * <code>y</code>. If the coordinates are invalid, an <code>ArrayIndexOutOfBoundsException</code> will be thrown. The calling function is not
     * obliged to catch it.
     * 
     * @param x horizontal position of the unit on the map.
     * @param y vertical position of the unit on the map.
     * @return an array of strings containing the file names of subordinate maps of a certain unit specified by coordinates <code>x</code> and
     *         <code>y</code>.
     */
    ...
    /**
     * Returns a 4-dimensional double array of the weight vectors. The first dimension represents units of a map in horizontal direction, the second
     * dimension represents the units of a map in vertical direction and the third dimension represents units of a map in depth.
     * 
