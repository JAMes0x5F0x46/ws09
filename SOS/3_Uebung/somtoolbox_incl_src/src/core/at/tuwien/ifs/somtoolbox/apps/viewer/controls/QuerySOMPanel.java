 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: QuerySOMPanel.java 2874 2009-12-11 16:03:27Z frank $
 */
public class QuerySOMPanel extends AbstractViewerControl implements ActionListener {
    ...
    private void doQuery(String query) {
        ...
        for (int i = 0; i < winners.length; i++) {
            labelText += winners[i].getXPos() + "/" + winners[i].getYPos() + "; ";
        }
    ...
    private String getText(String fileName) {
        ...
        try {
            ...
            if ((fileName.toLowerCase().endsWith(".htm")) || (fileName.toLowerCase().endsWith(".html"))) {
                ...
                JOptionPane.showMessageDialog(null, "Cannot get the content from the file " + fileName + "!", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public Dimension getPreferredSize() {
        return new Dimension(state.controlElementsWidth, 100);
    }
