...
/**
 * @author Rudolf Mayer
 * @version $Id: SharedSOMVisualisationData.java 2874 2009-12-11 16:03:27Z frank $
 */
public class SharedSOMVisualisationData {
    ...
    public SharedSOMVisualisationData() {
        ...
        objects.put(SOMVisualisationData.CLASS_INFO, new SOMVisualisationData(new String[] { "cls", "clsinf", "clsinfo", "classinfo", "txt" }, null,
                SOMLibClassInformation.class, SOMVisualisationData.CLASS_INFO));
        objects.put(SOMVisualisationData.REGRESS_INFORMATION, new SOMVisualisationData(new String[] { "reginf", "txt" }, null,
                SOMLibRegressInformation.class, SOMVisualisationData.REGRESS_INFORMATION));
        objects.put(SOMVisualisationData.DATA_INFO, new SOMVisualisationData(new String[] { "" }, null, SOMLibDataInformation.class,
                SOMVisualisationData.DATA_INFO));
        objects.put(SOMVisualisationData.DATA_WINNER_MAPPING, new SOMVisualisationData(new String[] { "dwm" }, null, SOMLibDataWinnerMapping.class,
                SOMVisualisationData.DATA_WINNER_MAPPING));
        objects.put(SOMVisualisationData.INPUT_VECTOR, new SOMVisualisationData(new String[] { "", "tfxidf" }, null, SOMLibSparseInputData.class,
                SOMVisualisationData.INPUT_VECTOR));
        objects.put(SOMVisualisationData.TEMPLATE_VECTOR, new SOMVisualisationData(new String[] { "tv" }, null, SOMLibTemplateVector.class,
                SOMVisualisationData.TEMPLATE_VECTOR));
        objects.put(SOMVisualisationData.LINKAGE_MAP, new SOMVisualisationData(new String[] { "linkage" }, null, DataItemLinkageMap.class,
                SOMVisualisationData.LINKAGE_MAP));
        objects.put(SOMVisualisationData.INPUT_CORRECTIONS, new SOMVisualisationData(new String[] { "correction" }, null, InputCorrections.class,
                SOMVisualisationData.INPUT_CORRECTIONS));
        objects.put(SOMVisualisationData.INPUT_VECTOR_DISTANCE_MATRIX, new SOMVisualisationData(new String[] { "dist", "dist.bin" }, null,
                InputVectorDistanceMatrix.class, SOMVisualisationData.INPUT_VECTOR_DISTANCE_MATRIX));
    }

    public SharedSOMVisualisationData(String classInformationFileName, String regressionInformationFileName, String dataInformationFileName,
            String dataWinnerMappingFileName, String inputVectorFileName, String templateVectorFileName, String linkageMapFileName) {
        this();
    ...
    public void readAvailableData() {
        for (SOMVisualisationData data : objects.values()) {
            if (data.getData() == null && data.getFileName() != null && !data.getFileName().equals("")) { // we got no data, but got a file name
                try {
                    data.readFromFile(data.getFileName());

                    // FIXME this is a bad hack, but needed until #78 (https://olymp.ifs.tuwien.ac.at/trac/somtoolbox/ticket/78) is implemented
