 ...
 * 
 * @author Rudolf Mayer
 * @version $Id: TemplateVectorElement.java 2874 2009-12-11 16:03:27Z frank $
 */
public class TemplateVectorElement implements Comparable<TemplateVectorElement> {
    ...
    /**
     * The term frequency in the whole collection - how often does this attribute show up in the whole collection of feature vectors, i.e. a counter
     * for the attribute, the sum of all values of the attribute (sum across all feature vectors).
     */
    ...
    public String toString() {
        ...
        if (meanTermFrequency != -1) {
            sb.append("\tmeanTf: " + StringUtils.format1FractionDigits.format(meanTermFrequency));
        }
    ...
    /** Merge the statistical information of the current template vector element with another element, used e.g. in {@link SOMLibInputMerger}. */
