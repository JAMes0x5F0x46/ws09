 ...
 * @author Thomas Lidy
 * @author Rudolf Mayer
 * @version $Id: SOMLibRegressInformation.java 2949 2009-12-15 15:21:15Z frank $
 */
public class SOMLibRegressInformation {
     ...
     * and the tab seperated file ({@link SOMLibClassInformation#readTabSepClassInformationFile()}).
     * 
