 ...
 * @version $Id: SemanticClass.java 2964 2009-12-16 15:08:06Z mayer $
 */
public class SemanticClass {
    ...
    /**
     * Lists all different partitions of the class (a Partition is consicered a connected Area of units with no more than 1 as distance between each
     * unit)
     */
    public void calculateClassPartitions() {
        ...
        for (int i = 0; i < UnitswithClassList.size(); i++) {
            // Gets the trail, since there are many equal trails, only keep unique trails
            // FIXME: refactor this (maybe as simple as using result.containsValue, though sorting might be importing)
            ArrayList<Integer> trail = getTrail(i, new ArrayList<Integer>());
    ...
    /**
     * Calculates How much of the class units lie in a radius around the middle point ( this radius is the mean over all distances from the middle
     * point to other class points)
     */
    ...
    /** Returns an ArrayList containing directions of the Units given in the ArrayList, measured to the centre of the Class */
    ...
    /**
     * Sets the setQMIntersectionClassArrayList, containing the Name of the QM on uneven places, and the IntersectionNodes-ArrayList on even Places
     * for Maximum Units of the QM
     */
