 ...
 * @version $Id: RegionManager.java 2874 2009-12-11 16:03:27Z frank $
 */
public class RegionManager {
    ...
    Simplex initialTriangle = new Simplex(new Pnt[] { new Pnt(-initialSize, -initialSize), new Pnt(initialSize, -initialSize),
    ...
    public RegionManager(SOMLibClassInformation classInfo, PaintList paintList, int width, int height, double min_visible_class) {
        this(classInfo, paintList, width, height, min_visible_class, DEFAULT_ZOOM_FACTOR);
    }

    /** Creates a new instance of SOMegions */
    public RegionManager(SOMLibClassInformation classInfo, PaintList paintList, int width, int height, double min_visible_class, int zoom) {
    ...
    public void build() {
        ProgressListener progressWriter = ProgressListenerFactory.getInstance().createProgressListener(regions.size(), "Processing region ", 10);
    ...
    /**
     * Goes through all the Regions and returns the Region with smallest Entropy Error. This is used in the End to spread the Value among the whole
     * Palette Interval (used for Visualization)
     * 
    ...
    /**
     * Goes through all the Regions and returns the Region with biggest Entropy Error. This is used in the End to spread the Value among the whole
     * Palette Interval (used for Visualization)
     * 
