...
Ein n-dimensionales Array $A$  \"uber ein Alaphabet $V$ (Menge aller non-terminal und terminal Symbole) ist eine Funktion 
...
\]
endlich ist und $\# \not \in  V$ als \textit{background} oder \textit{blank Symbol} bezeichnet wird.
}
