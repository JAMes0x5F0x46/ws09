 ...
 * 
 * @author neumayer
 * @version $Id: SecondLifeInputFileReader.java 2874 2009-12-11 16:03:27Z frank $
 */
public class SecondLifeInputFileReader {
    ...
    public SecondLifeInputFileReader(String secondLifeCoordinateFile) throws IOException {
        ...
        for (int index = 0; (line = br.readLine()) != null; index++) {
            ...
            // System.out.println(index + " | " + uids[index] + new Point3d(Double.parseDouble(elements[2]), Double.parseDouble(elements[3]),
            // Double.parseDouble(elements[4])));
            positions[index] = new Point3d(Double.parseDouble(elements[2]), Double.parseDouble(elements[3]), Double.parseDouble(elements[4]));
