...
/**
 * @author Rudolf Mayer
 * @version $Id: MapPanel.java 2874 2009-12-11 16:03:27Z frank $
 */
public class MapPanel extends JPanel {
    ...
    public void createNodes(int totalNodes) {
        int x = (int) Math.round(Math.sqrt((double) totalNodes * aspectRatio));
        int y = (int) Math.round((double) x / aspectRatio);
    ...
    private void setNodes() {
        ...
        for (int col = 0; col < toDraw.length; col++) {
            for (int row = 0; row < toDraw[0].length; row++) {
                ...
                // System.out.println("blue value:" + backgroundImageMap.getColorModel().getBlue(backgroundImageMap.getRGB(xPos, yPos)));
                // System.out.println("red value:" + backgroundImageMap.getColorModel().getRed(backgroundImageMap.getRGB(xPos, yPos)));
                // System.out.println("green value:" + backgroundImageMap.getColorModel().getGreen(backgroundImageMap.getRGB(xPos, yPos)));
                // }
            }
        }
