 ...
 * 
 * @version $Id: MnemonicGrowingLayer.java 2874 2009-12-11 16:03:27Z frank $
 * @author Rudolf Mayer
 */
public class MnemonicGrowingLayer extends GrowingLayer {
    ...
    public void countDistances(int distanceFromStart, Unit startUnit, Unit currentUnit) {
        ...
        if (distanceMatrix_[startUnit.getXPos()][startUnit.getYPos()][startUnit.getZPos()][xpos][ypos][zpos] == null
            ...
            distanceMatrix_[startUnit.getXPos()][startUnit.getYPos()][startUnit.getZPos()][xpos][ypos][zpos] = new Integer(distanceFromStart);
            ...
            for (int row = 0; row < units[0].length; row++) {
                for (int slice = 0; slice < units[0][0].length; slice++) {
                    ...
                    if (units[col][row][slice] != null) {
                        progressWriter.progress("Calculating distance of unit " + col + "/" + row + "/" + slice + ", ", (currentUnitNum + 1));
    ...
    public MnemonicGrowingLayer(int id, Unit su, int x, int y, String metricName, int d, double[][][] vectors, long seed) throws SOMToolboxException {
        this(id, su, x, y, 0, metricName, d, GrowingLayer.addDimension(x, y, vectors), seed);
    }

    public MnemonicGrowingLayer(int id, Unit su, int x, int y, int z, String metricName, int d, double[][][][] vectors, long seed)
    ...
    public Unit[] getAllUnits() {
        ...
        return (Unit[]) tempUnits.toArray(new Unit[tempUnits.size()]);
    }
